...
(*2}}}1}}}*)
(*{{{1 count_var Count vars in a pterm.  @param t (pterm): the pterm.  @return (nat): the number of vars in `t`.  *) Fixpoint count_var (t: pterm): nat := match t with V _       => 1 | Un t'     => count_var t' | Pr t' t'' => count_var t' + count_var t'' | F _ t'    => count_var t' end.  (*{{{2 Example*)
